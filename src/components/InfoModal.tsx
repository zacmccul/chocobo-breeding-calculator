        ...
        <DialogBody overflowY="auto">
          <VStack align="stretch" gap={6} pb={4}>
            ...
            <Box>
              ...
              <List.Root gap={3}>
                <List.Item>
                  ...
                  <Text ml={4}>
                    Sort your chocobos by Quality (total stats), Locked Stats (4-star stats from
                    both parents), or Four Star Stats (any 4-star stats). Choose ascending or
                    descending order.
                  </Text>
                </List.Item>
                <List.Item>
                  ...
                  <Text ml={4}>
                    ...
                    "Maximum Speed: at least 4 stars from all parents."
                  </Text>
                </List.Item>
                <List.Item>
            ...
            <Box>
              ...
              <Text mb={3}>
                For example, a chocobo that has parental stats of 4 and 1 stars for a given stat could end up with either 4 or 1 star in that stat when registered. Importantly, a fledgling inherits from their father's two inherited stat sets (coin flipped for each stat), and similarly from the mother. In other words, a fledgling chocobo's race statistics are determined by their parents' inherited stat sets, not the parents' own racing stats.
              </Text>
              <Text mb={4}>
                The ultimate goal of chocobo breeding is to have 4 stars in each stat inherited from both the mother and father. When this is achieved, the chocobo will always have 4 stars in each stat when registered or bred.
              </Text>
              ...
              <Text mb={3}>
                You may notice the calculator sometimes prioritizes lower stats when a 4-star pairing isn't possible. This is strategic: when ranking up a chocobo, you want to minimize MGP spent on attribute increases by having the most important stats (Max Speed and Stamina) very high and less important ones (Cunning and Acceleration) very low.
              </Text>
              <Text mb={3}>
              ...
              <Text mb={4}>
                However, we still prioritize 4 stars in as many stats as possible to minimize generations needed. Once you have chocobos with 4 stars in all stats from at least one parent, you can inbreed to get your perfect chocobo.
              </Text>
              ...
              <List.Root gap={3} mb={3}>
                <List.Item>
                  <Text fontWeight="semibold">Priority #1 - Stats with at least one 4-star:</Text>
                  <Text ml={4}>
                    These give you a chance to eventually breed perfect offspring. Without any 4-star in a stat, you can never reach perfection in that attribute.
                  </Text>
                </List.Item>
                <List.Item>
                  <Text fontWeight="semibold">Priority #2 - "Locked" stats (both parents have 4 stars):</Text>
                  <Text ml={4}>
                    These guarantee at least one 4-star for their children in that stat.
                  </Text>
                </List.Item>
                <List.Item>
              ...
              <Text mb={4}>
                <Text as="span" fontWeight="semibold">Example:</Text> A chocobo with stats like [4,1], [1,4], [4,1] is considered better than [4,4], [4,4], [3,4]. Why? When breeding 9 offspring, the first has high odds of producing a child that receives all three 4-stars from the parent, while the second is guaranteed only 2 four-stars maximum.
              </Text>
